...
export default function DatasetSelectCard({ dataset, selected, onSelect }) {
  const isClassification = dataset.task?.endsWith("_classification");
        ...
        {dataset.task && (
          <span
            className={[
              ...
              selected ? "bg-emerald-900/40 text-emerald-200" : "bg-slate-800 text-slate-200",
            ].join(" ")}
          >
            {dataset.task}
          </span>
